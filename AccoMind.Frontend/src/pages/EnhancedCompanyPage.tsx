...
import { CompanyService, GoogleSearchResult, CompanyDocumentSummary } from "@/services/companyService";

const EnhancedCompanyPage: React.FC = () => {
  ...
  const [documentSummaries, setDocumentSummaries] = useState<CompanyDocumentSummary[]>([]);
        ...
        <div className="mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600">Comprehensive company insights and financial analysis</p>
            </div>
                      ...
                      <div key={index} className="border-b border-gray-200 last:border-b-0 pb-4 last:pb-0">
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-green-600 mb-2">{result.displayUrl}</p>
                      ...
                      <div key={index} className="border border-gray-200 rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                          <div className="bg-blue-50 p-3 rounded-lg">
                            ...
                            <p className="text-lg font-bold text-blue-600">{doc.financialHighlights.revenue}</p>
                          </div>
                          <div className="bg-green-50 p-3 rounded-lg">
                            ...
                            <p className="text-lg font-bold text-green-600">{doc.financialHighlights.profit}</p>
                          </div>
                          <div className="bg-purple-50 p-3 rounded-lg">
                            ...
                            <p className="text-lg font-bold text-purple-600">{doc.financialHighlights.growth}</p>
                          </div>
                        </div>
